...
import com.hjs.pages.MyGroupBuyPageObject;
import com.hjs.pages.MyRedeemProductDetailPageObject;
import com.hjs.pages.OnlineCustomerPageObject;
...
public class TradeTestCase extends CommonAppiumTest{
	private static String DEPOSITE_PRODUCT_NAME="黄XAutoTest产品180403055921";
	private static String DEPOSITE_GROUPBUYPRODUCT_NAME="黄XAutoTest团购产品170919042116";
	private static String DEPOSITE_TRANSPRODUCT_NAME="黄XAutoTest可转让产品180322110723";
	...
	private static String bankPhoneNum1="18032223315";
    ...
    public void testPayRegularProductsByBankCardWithoutCoupon() throws Exception{
    	...
    	InvestResultPageObject investResultPage=payPage.payByBankCardWithoutCoupon(bankCardPwd1, bankPhoneNum1);
    	...
    	String transNo=dbOperation.getTransNoByPhoneNum(phoneNum1);
    ...
    public void testPayRegularProductsByBankCardWithCashCoupon() throws Exception{
    	...
    	payPage.deleteUserCoupon(phoneNum1);
    	String couponId="2463";
    	Assert.assertTrue(payPage.addCouponToUser(phoneNum1, couponId), "加券失败");
    	investPage.invest(startMonney);
    	Assert.assertTrue(payPage.verifyInthisPage(), "点击确认投资未跳转到支付页面");
    	InvestResultPageObject investResultPage=payPage.payByBankCardWithCoupon(bankCardPwd1, bankPhoneNum1,couponId);
    	Assert.assertTrue(investResultPage.verifyInthisPage(), "支付后未跳转到支付结果页面");
    	String investResult=investResultPage.getInvestResult();
    	Assert.assertTrue(investResult.equals("投资申请已受理")||investResult.contains("已提交"), "投资失败，投资结果为:"+investResult);
    }
    ...
    public void testPayRegularProductsByBankCardWithBonusCoupon() throws Exception{
    	...
    	Assert.assertTrue(investPage.verifyInthisPage(), "点击立即投资后未进入到投资页");
    	PayPageObject payPage=new PayPageObject(driver);
    	payPage.deleteUserCoupon(phoneNum1);	//清除用户所有优惠券
    ...
    public void testPayRegularProductsByBankCardWithoutCouponWithoutSmsCode() throws Exception{
    	...
    	PayPageObject payPage=investPage.invest(startMonney);
    	Assert.assertTrue(payPage.verifyInthisPage(), "点击确认投资未跳转到支付页面");
    	InvestResultPageObject investResultPage=payPage.payByBankCardWithoutCouponWithoutSmsCode(bankCardPwd1, bankPhoneNum1);
    	Assert.assertTrue(investResultPage.verifyInthisPage(), "支付后未跳转到支付结果页面");
    	String investResult=investResultPage.getInvestResult();
    	Assert.assertTrue(investResult.equals("投资申请已受理")||investResult.contains("已提交"), "投资失败，投资结果为:"+investResult);
    }
    ...
    public void testtestPayRegularProductsByBankCardWithCashCouponWithoutSmsCode() throws Exception{
    	...
    	investPage.invest(startMonney);
    	Assert.assertTrue(payPage.verifyInthisPage(), "点击确认投资未跳转到支付页面");
    	InvestResultPageObject investResultPage=payPage.payByBankCardWithCouponWithoutSmsCode(bankCardPwd1, bankPhoneNum1,couponId);
    	Assert.assertTrue(investResultPage.verifyInthisPage(), "支付后未跳转到支付结果页面");
    	String investResult=investResultPage.getInvestResult();
    	Assert.assertTrue(investResult.equals("投资申请已受理")||investResult.contains("已提交"), "投资失败，投资结果为:"+investResult);
    }
    ...
    public void testRecharge()throws Exception{
    	...
    	RechargeResultPageObject rechargeResultPage=rechargePage.recharge(stringRechargeAmount, bankCardPwd1, bankPhoneNum1);
    ...
    public void testPayRegularProductsByBanlanceWithoutCoupon() throws Exception{
    	...
    	investPage.invest(startMonney);
    	Assert.assertTrue(payPage.verifyInthisPage(), "点击确认投资未跳转到支付页面");
    	InvestResultPageObject investResultPage=payPage.payByBanlanceWithoutCoupon(bankCardPwd1, bankPhoneNum1);
    	Assert.assertTrue(investResultPage.verifyInthisPage(), "支付后未跳转到支付结果页面");
    	String investResult=investResultPage.getInvestResult();
    	Assert.assertTrue(investResult.equals("投资申请已受理")||investResult.contains("已提交"), "投资失败，投资结果为:"+investResult);
    ...
    public void testPayRegularProductsByBanlanceWithCashCoupon() throws Exception{
    	...
    	investPage.invest(startMonney);
    	Assert.assertTrue(payPage.verifyInthisPage(), "点击确认投资未跳转到支付页面");
    	InvestResultPageObject investResultPage=payPage.payByBanlanceWithCoupon(bankCardPwd1, bankPhoneNum1, couponId);
    	Assert.assertTrue(investResultPage.verifyInthisPage(), "支付后未跳转到支付结果页面");
    	String investResult=investResultPage.getInvestResult();
    	Assert.assertTrue(investResult.equals("投资申请已受理")||investResult.contains("已提交"), "投资失败，投资结果为:"+investResult);
    ...
    public void testPayCurrentProductsByBanlanceWithoutCoupon() throws Exception{
    	...
    	String productId=db.getCurrentProductId(CURRENTDEPOSITE_PRODUCT_NAME);
    	InitProduct product = new InitProduct.Builder("").build();
    	product.updateProductWhiteList(productId, "419");
    ...
    public void testPayByBankCardFailWithoutCoupon() throws Exception{
    	...
    	PayPageObject payPage=investPage.invest(startMonney);
    	Assert.assertTrue(payPage.verifyInthisPage(), "点击确认投资未跳转到支付页面");
    	InvestResultPageObject investResultPage=payPage.payByBankCardFailWithoutCoupon(bankCardPwd1, bankPhoneNum1);
    	Assert.assertTrue(investResultPage.verifyInthisPage(), "支付后未跳转到支付结果页面");
    	String investResult=investResultPage.getInvestResult();
    	Assert.assertTrue(investResult.contains("失败"),"未跳转到投资失败页面，页面信息为:"+investResult);

    }
    @Test(priority = 15,description="测试投资页")
    public void testInvestPage() throws Exception{
    	...
    	InvestPageObject investPage=depositProductDetailPage.clickPayBtn();
    	Assert.assertTrue(investPage.verifyInthisPage(), "点击立即投资后未进入到投资页");
    	investPage.testNotClickAgreementCheckBox();
    	investPage.testInvestMoney();
    }
    @Test(priority = 16,expectedExceptions = Exception.class, expectedExceptionsMessageRegExp="找不到下架产品",description="下架产品")
    ...
    @Test(priority = 17,description="提现")
    public void testWithdraw()throws Exception{
    	...
    	if(withdrawCashPage.getWithdrawCount()>0){
	    	WithdrawCashResultPageObject withdrawCashResultPage=withdrawCashPage.withdrawCash(stringHalfWithdrawCash, bankCardPwd1);
    ...
    @Test(priority = 18,description="账户余额展示及掩码")
    ...
    @Test(priority = 19,description="余额交易明细")
    ...
    @Test(priority = 20,description="恒存金明细")
    ...
    @Test(priority = 21,description="我的定期产品资产、预期收益确认")
    ...
    @Test(priority = 22,description="我的-交易记录")
    public void testTransRecorder()throws Exception{
    	...
    	transRecordPage.gotoTransRecordDetailPageAndAssert();
    }
    @Test(priority = 23,description="我的定期产品信息")
    public void testMyRegularProductInfo()throws Exception{
    	...
    	myDepositeProductDetailPage.assertMtpAndAppDetail(phoneNum1);
    }
    @Test(priority = 24,description="定期回款设置到银行卡")
...
//    	myDepositeProductDetailPage.assertBackMoneyTo("至银行卡");
    ...
    @Test(priority = 25,description="发起团")
    public void testBuyGroupBuyProduct()throws Exception{
    	...
    	GroupBuyInfo.setInvestDate();
    }
    @Test(priority = 26,description="我的页-我的团购")
    public void testMyGroupBuyPage()throws Exception{
    	new HomePageObject(driver).backToHomePage(1,4,7,8);
    	HomePageObject homepage=new HomePageObject(driver); 
    	CommonAppiumPage page=homepage.enterPersonEntrace();
    	String pageName=page.getClass().getName();
    	Assert.assertTrue(pageName.contains("MinePageObject"), "点击首页-我的入口未进入我的页面");
    	MyGroupBuyPageObject myGroupBuyPage=((MinePageObject)page).enterMyGroupBuyPage();
    	Assert.assertTrue(myGroupBuyPage.verifyInthisPage(), "点击我的团购为跳转到我的团购页面");
    	myGroupBuyPage.assertMyGroupBuyInfo();
    	myGroupBuyPage.assertEndGroupBuyInfo();
    }
    @Test(priority = 27,description="检查已买团购信息")
    ...
    @Test(priority = 28,description="现金券购买团购产品",enabled = false)
    ...
    @Test(priority = 29,description="参与团")
...
//    	GroupBuyInfo.setLvupReward(lvupReward);
    ...
    @Test(priority = 30,description="购买金额、人数达到团购加息阶梯")
...
//    	GroupBuyInfo.setLvupReward(lvupReward);
    ...
    @Test(priority = 31,expectedExceptions = Exception.class, expectedExceptionsMessageRegExp="找不到下架产品",description="下架团购产品")
    ...
    @Test(priority = 32,description="购买可转让产品")
    ...
    @Test(priority = 33,description="转让产品")
    public void testTransTransProduct()throws Exception{
    	...
    	TransResultPageObject transResultPage=transConfirmPage.confirmTrans(bankCardPwd1);
    ...
    @Test(priority = 34,description="撤销转让产品")
    public void testCancleTransProduct()throws Exception{
    	...
    	TransCancelResultPageObject transCancelResultPage=transCancleDetailPage.cancelTrans(bankCardPwd1);
    ...
    @Test(priority = 35,description="受让产品")
    ...
    @Test(priority = 36,description="转让受让产品")
    ...
    @Test(priority = 37,description="撤销转让受让产品")
    ...
    @Test(priority = 38,expectedExceptions = Exception.class, expectedExceptionsMessageRegExp="找不到下架产品",description="下架可转让产品")
    ...
    @Test(priority = 39,description="我的定期产品已回款确认")
    public void testMyRegularProductRedeemInfo()throws Exception{
		...
		pageName=page.getClass().getName();
		Assert.assertTrue(pageName.contains("LoginPageObject"), "验证手机号后未进入登录页面");
		GesturePwd gesturePwd=((LoginPageObject)page).login(loginPwd1);
		if(gesturePwd.verifyInthisPage()){
			Assert.assertTrue(gesturePwd.verifyInthisPage(),"登录后未跳转到手势密码页");
	    	Assert.assertEquals("请绘制您的手势密码", gesturePwd.verifyGestureTips(),"登录后未进入设置手密页");
	    	String result=gesturePwd.setFirstGesturePwd(1,4,7,8);
    ...
    @Test(priority = 40,description="基金开户",enabled=false)
    ...
    @Test(priority = 41,description="基金申购",enabled=false)
    ...
    @Test(priority = 45,description="总资产展示")
    ...
    @Test(priority = 46,description="掩码测试")
    ...
    @Test(priority = 47,description="站内信测试")
    ...
    @Test(priority = 48,description="优惠券展示")
    public void testCouponView()throws Exception{
    	new HomePageObject(driver).backToHomePage(1,4,7,8);
    	HomePageObject homepage=new HomePageObject(driver); 
    	DBOperation dbOperation=new DBOperation();
    	dbOperation.deleteUserCoupon(phoneNum1);	//清除用户优惠券
    	CommonAppiumPage page=homepage.enterPersonEntrace();	
    	String pageName=page.getClass().getName();
    	Assert.assertTrue(pageName.contains("MinePageObject"), "点击首页-我的入口未进入我的页面");
    	...
    	//验证增加一张券前端展示
    	String couponId="2465";
    	Assert.assertTrue(dbOperation.addCouponToUser(phoneNum1, couponId), "加券失败");
    ...
    @Test(priority = 49,description="我的页-在线客服")
    public void testOnlineCustomerService()throws Exception{
    	new HomePageObject(driver).backToHomePage(1,4,7,8);
    	HomePageObject homepage=new HomePageObject(driver); 
    	CommonAppiumPage page=homepage.enterPersonEntrace();
    	String pageName=page.getClass().getName();
    	Assert.assertTrue(pageName.contains("MinePageObject"), "点击首页-我的入口未进入我的页面");
    	OnlineCustomerPageObject onlineCustomerPage=((MinePageObject)page).enterOnlineCustomerService();
    	Assert.assertTrue(onlineCustomerPage.verifyInthisPage(), "点击在线客服页未跳转到在线客服页面");
    	onlineCustomerPage.testSendMsg();
    }
    @Test(priority = 50,description="因缓存延时判断定期回款设置到银行卡")
    public void testAssertBackMoneySettingToBankCard()throws Exception{
    	new HomePageObject(driver).backToHomePage(1,4,7,8);
    	HomePageObject homepage=new HomePageObject(driver); 
    	CommonAppiumPage page=homepage.enterPersonEntrace();
    	String pageName=page.getClass().getName();
    ...
    @Test(priority = 51,description="定期回款设置到余额")
