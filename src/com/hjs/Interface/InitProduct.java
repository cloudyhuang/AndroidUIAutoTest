...
public class InitProduct {
	...
	private String transRuleTmplId;
	...
	public static class Builder{    
		...
		private String transRuleTmplId=null;
        ...
        public Builder setIsSupportTrans(boolean isSupportTrans){    
            this.isSupportTrans = isSupportTrans;    
            return this;    
        }
        public Builder setTransRuleTmplId(String transRuleTmplId){    
            this.transRuleTmplId = transRuleTmplId;    
            return this;    
        }
    ...
    private InitProduct(Builder builder){     
        ...
        this.isSupportTrans=builder.isSupportTrans;
        this.transRuleTmplId=builder.transRuleTmplId;
    }  
	...
	public void creatProduct(String assetsId,String planId) throws ParseException{
		...
		postJsonobj.getJSONObject("baseInfo").put("isSupportTrans", isSupportTrans);
		postJsonobj.getJSONObject("baseInfo").put("transRuleTmplId", transRuleTmplId);
